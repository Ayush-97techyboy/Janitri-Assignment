...
const dummyDevices = [
  {
    ...
    lastInstallationDate: '2022-12-15',
    amcStatus: 'Active',
  },
  {
    id: '2',
    ...
    lastInstallationDate: '2023-01-10',
    amcStatus: 'Expired',
  },
]
...
const DeviceInventory = () => {
  ...
  useEffect(() => {
    ...
    if (storedDevices) {
      ...
      // If no devices in localStorage, set dummy devices
      localStorage.setItem('devices', JSON.stringify(dummyDevices))
